...
> {
  ...
  componentDidUpdate(
    prevProps: InputTextAreaProps,
    prevState: InputTextAreaState,
  ) {
    if (
      !prevProps.isFocus &&
      this.props.isFocus &&
      this.state.ref.current !== null
    ) {
    ...
    if (
      ...
      this.setState({
        ...
        scrollHeight: this.state.ref.current.scrollHeight,
      });
      return;
    }
    ...
    if (
      this.state.ref.current !== null &&
      this.state.ref.current.scrollHeight !== this.state.scrollHeight
    ) {
